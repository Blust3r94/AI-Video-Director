...
export default function ReviewPage() {
  ...
  if (!brief) {
    return <main className="project-page"><nav><Link className="brand" href="/">AI VIDEO DIRECTOR</Link></nav><section className="empty"><h1>Nessun brief ancora.</h1><p>Prima crea un progetto, poi potrai rivedere il piano.</p><Link className="primary" href="/projects/new">Crea un progetto</Link></section></main>;
  }
  ...
  if (plan === undefined) {
    return <main className="project-page"><nav><Link className="brand" href="/">AI VIDEO DIRECTOR</Link><span className="pill">STEP 03 / 04</span></nav><section className="review"><p className="eyebrow">REVIEW & APPROVAL</p><h1>Carico il piano…</h1></section></main>;
  }
