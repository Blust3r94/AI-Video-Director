...
export default function PlanPage() {
  ...
  })}</ol></section><div className="plan-actions"><Link href="/projects/new">Modifica il brief</Link><button onClick={() => router.push("/projects/review")}>Vai alla review</button></div></main>;
}
