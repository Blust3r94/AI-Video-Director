...
const expectedTables = ["workspaces", "memberships", "users", "sessions", "projects", "project_briefs", "production_plans", "characters", "locations", "sequences", "scenes", "clips", "jobs", "activity_events"];
